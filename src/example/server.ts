...
const schema: Schema<_Context0> = {
  Person: {
    ...
    fields: {
      id: {
        ...
        name: "id",
        description: undefined,
        resultType: ({"kind":"Number","loc":{"fileName":"/src/example/objects/Person.ts","line":11}} as any),
      ...
      name: {
        ...
        name: "name",
        description: undefined,
        resultType: ({"kind":"Union","elements":[{"kind":"Null"},{"kind":"String"}],"loc":{"fileName":"/src/example/objects/Person.ts","line":12}} as any),
        argType: {kind: SchemaKind.Void},
        auth: 'public',
    ...
    mutations: {
      set: {
        ...
        argType: ({"kind":"Object","properties":{"field":{"kind":"String","loc":{"fileName":"/src/example/objects/Person.ts","line":40}},"value":{"kind":"String","loc":{"fileName":"/src/example/objects/Person.ts","line":40}}},"loc":{"fileName":"/src/example/objects/Person.ts","line":40}} as any),
        auth: 'public',
  ...
  Email: {
    ...
    name: "Email",
    description: undefined,
    baseType: ({"kind":"String","loc":{"fileName":"/Users/forbeslindesay/GitHub/ts-bicycle/src/example/scalars/Email.ts","line":7}} as any),
  ...
  RichText: {
    ...
    name: "RichText",
    description: undefined,
    baseType: ({"kind":"Object","properties":{"___html":{"kind":"String","loc":{"fileName":"/Users/forbeslindesay/GitHub/ts-bicycle/src/example/scalars/RichText.ts","line":3}}},"loc":{"fileName":"/Users/forbeslindesay/GitHub/ts-bicycle/src/example/scalars/RichText.ts","line":7}} as any),
